      ...
      <div className="min-h-screen bg-background">
        <div className="border-b border-border bg-card/50">
          <div className="container py-4 sm:py-6">
            <div className="h-8 bg-muted animate-pulse rounded w-20 mb-4" />
            <div className="h-10 bg-muted animate-pulse rounded w-40 mb-2" />
            <div className="h-4 bg-muted animate-pulse rounded w-60" />
          </div>
        </div>
        ...
        <div className="container py-4 sm:py-6">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Gerencie suas chaves de API e configurações de risco
            </p>
          </div>
        </div>
      </div>
